        ...
        <Slider {...settings}>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://www.youtube.com/watch?v=h2_CZCM9_-E"><i className="fa fa-facebook"></i></a></li>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://movie.naver.com/movie/bi/mi/mediaView.naver?code=185917&mid=45747#tab"><i className="fa fa-facebook"></i></a></li>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://movie.naver.com/movie/bi/mi/mediaView.naver?code=192150&mid=49680#tab"><i className="fa fa-facebook"></i></a></li>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://www.youtube.com/watch?v=rO3gF04G-2I"><i className="fa fa-facebook"></i></a></li>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://www.youtube.com/watch?v=tngyy2UcWuI"><i className="fa fa-facebook"></i></a></li>
            ...
            <div className="card-wrapper">
                <div className="card">
                    ...
                    <ul className="social-icons">
                        <li><a href="https://www.youtube.com/watch?v=JQ2rukD8B8U"><i className="fa fa-facebook"></i></a></li>
